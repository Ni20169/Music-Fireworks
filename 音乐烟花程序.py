...
root = Tk()
root.withdraw()  # 隐藏主窗口
music_path = filedialog.askopenfilename(title="选择音乐文件", filetypes=[("MP3 文件","*.mp3")])
if not music_path:
    sys.exit("未选择音乐文件，程序退出！")

# 弹窗输入文字
text_input = simpledialog.askstring("输入文字", "请输入烟花显示文字：", initialvalue="2025，你好！")
if not text_input:
    text_input = "2025，你好！"
